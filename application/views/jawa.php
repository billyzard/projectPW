...
<div id="contents">
  <div class="container" style="margin-bottom:20px">
    <br>
    <h2><span>JAWA</span></h2>
    <div class="row">
      <div class="container-fluid">
        <div class="col-sm-8" style="background-color: ##f1f1f1; border-radius:10px; padding-bottom:20px"><br>
          <div id="about">
            <center><img src="<?php echo base_url('assets/jawa.png')?>" width="75" height="75" ></center>
            <br><br>
            Masakan Jawa adalah masakan khas yang berasal dari pulau Jawa, kecuali Jawa Barat yang mempunyai kekhasan khusus sebagai Masakan Sunda. Masakan Jawa tersedia di Warung Tegal. Masakan Jawa tempe menjadi masakan internasional dan menjadi satu satunya masakan Indonesia yang tidak terpengaruh oleh masakan Tionghoa, masakan India, atau masakan Arab<br><br>
            Menu yang Tersedia : <br><br>
            Pecel : Rp. 10.000<br>
            Rawon : Rp. 20.000<br>
            Soto Kediri : Rp. 50.000<br>
            All You can eat : Rp. 100.000<br>
            <br>
            <form action="<?php echo base_url('index.php/Paws/belijawa') ?>" method="post">
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/jw1.png')?>">
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="jawa1">Beli Sekarang</button>
              </div>
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/jw2.png')?>">
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="jawa2">Beli Sekarang</button>
              </div>
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/jw3.png')?>">
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="jawa3">Beli Sekarang</button>
              </div>
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/jw4.png')?>" height="121px">
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="jawa4">Beli Sekarang</button>
              </div>
            </form>
          </div>
        </div>
