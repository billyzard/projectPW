...
<div id="contents">
  <div class="container" style="margin-bottom:20px">
    <br>
    <h2><span>SUNDA</span></h2>
    <div class="row">
      <div class="container-fluid">
        <div class="col-sm-8" style="background-color: #f1f1f1; border-radius:10px; padding-bottom:20px"><br>
          <div id="about">
            <center><img src="<?php echo base_url('assets/sunda.png'); ?>" width="75" height="75" ></center>
            <br><br>
            GMasakan Sunda adalah masakan dari masyarakat Sunda di Jawa Barat, Indonesia. Ini adalah salah salah satu makanan yang paling populer di Indonesia. Makanan Sunda memiliki ciri kesegaran bahannya, lalap terkenal dimakan dengan sambal dan juga karedok menunjukkan kegemaran orang Sunda terhadap sayuran mentah segar. Berbeda dengan masakan minangkabau yang kaya rasa dan pedas dengan kandungan bumbu kari dan santan yang kental, masakan Sunda menampilkan citarasa yang ringan, sederhana, dan jelas; berkisar antara gurih asin, asam segar, manis ringan, dan pedas.<br>
            <br>
            Menu Yang Tersedia : Harga <br><br>
            Batagor : Rp 10.000<br>
            Soto bandung : Rp 20.000<br>
            Pepes ikan  : Rp 50.000<br>
            All you can eat : Rp 100.000<br><br>
            <form action="<?php echo base_url('index.php/Paws/beliGar'); ?>" method="post">
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/snd1.png')?>"/>
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="gare1">Beli Sekarang</button>
              </div>
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/snd2.png')?>"/>
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="gare2">Beli Sekarang</button>
              </div>
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/snd3.png')?>"/>
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="gare3">Beli Sekarang</button>
              </div>
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/snd4.png')?>"/>
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="gare4">Beli Sekarang</button>
              </div>
            </form>
          </div>
        </div>
