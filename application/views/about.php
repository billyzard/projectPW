  ...
  <div class="row"> 
   <div class="container-fluid"> 
    <div class="col-sm-8" style="background-color: #FCB315; border-radius:10px;"><br> 
     <div id="about"> 
     <h4><span>eAt IT</span></h4> 
     Merupakan web pelayanan pemesanan order makanan dengan sistem top up account sehingga saat kamu duduk di warung kami, kamu tidak perlu untuk takut lagi kekurangan uang, atau menunggu waiter untuk mencatat pesanan kamu!
     <br> 
     <h4><span>What Can You Get?</span></h4> 
     Easy.Fast.No Worry.     <br> 
     <h4><span>Alamat</span></h4>   
     Puri Indah A3/15, Jatidanger 
     <br> 
     <h4><span>Author</span></h4> 
     <br>Herizal Kurniawan 140810160019<br>
     <br>Teguh Riandi Pratama 140810160025<br>
     <br><br> 
     <br><br><br> 
     </div> 
    </div> 
