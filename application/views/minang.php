...
<div id="contents">
  <div class="container" style="margin-bottom:20px">
    <br>
    <h2><span>MINANG</span></h2>
    <div class="row">
      <div class="container-fluid">
        <div class="col-sm-8" style="background-color: ##f1f1f1; border-radius:10px; padding-bottom:20px"><br>
          <div id="about">
            <center><img src="<?php echo base_url('assets/minang.png')?>" width="75" height="75" ></center>
            <br><br>
            Masakan Padang adalah nama yang digunakan untuk menyebut segala jenis masakan yang berasal dari kawasan Minangkabau, provinsi Sumatera Barat, Indonesia. Semua jenis masakan ini lebih populer dengan sebutan masakan Padang. Meskipun sesungguhnya berbagai resep masakan Sumatera Barat mayoritas tidak berasal dari kota Padang, misalnya kota Bukittinggi, Solok,Padang Pariaman, Payakumbuh, dan sebagainya juga dikenal memiliki tradisi kuliner yang kaya. Rumah makan Padang atau rumah makan urang awak adalah sebutan untuk usaha rumah makan yang khusus menyajikan masakan Padang di luar daerah.<br><br>
            Menu yang tersedia : <br><br>
            Ayam Pop : Rp. 10.000<br>
            Gulai Cincang : Rp. 20.000<br>
            Rendang : Rp. 50.000<br>
            All you can eat : Rp. 100.000<br>
            <br>
            <form action="<?php echo base_url('index.php/Paws/beliMega'); ?>" method="post">
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/mng1.png')?>">
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="mega1">Beli Sekarang</button>
              </div>
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/mng2.png')?>">
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="mega2">Beli Sekarang</button>
              </div>
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/mng3.png')?>">
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="mega3">Beli Sekarang</button>
              </div>
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/mng4.png')?>">
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="mega4">Beli Sekarang</button>
              </div>
            </form>
          </div>
        </div>
