...
<div id="contents">
  <div class="container" style="margin-bottom:20px">
    <br>
    <h2><span>Cara Pembelian</span></h2>
    <div class="row">
      <div class="container-fluid">
        <div class="col-sm-8" style="background-color: #FCB315; border-radius:10px;"><br>
          <div id="about">
          <h4><span>Cara Order Makanan</span></h4>
          ·         Datang dulu ke warung kita<br>
          ·         Pastikan kamu telah memiliki akun eAt IT jika belum tekan tombol register<br>
          ·         Jika sudah lalu login, dan pastikan kamu memiliki saldo<br>
          ·         Jika saldo kamu tidak cukup, lakukan top up<br>
          ·         Pesan makanan / minuman yang kamu mau<br>
          ·         Tunggu<br>
          ·         Enjoy :)<br>
          ·       
          ·         Silahkan periksa rincian pemesanan Anda pada Sub-Menu “Riwayat Transaksi”<br><br>
