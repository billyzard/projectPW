...
<div id="contents">
  <div class="container" style="margin-bottom:20px">
    <br>
    <h2><span>WESTERN</span></h2>
    <div class="row">
      <div class="container-fluid">
        <div class="col-sm-8" style="background-color: ##f1f1f1; border-radius:10px; padding-bottom:20px"><br>
          <div id="about">
            <center><img src="<?php echo base_url('assets/pizza .png')?>" width="75" height="75" ></center>
            <br><br>
            European cuisine, or alternatively Western cuisine, is a generalised term collectively referring to the cuisines of Europe and other Western countries including (depending on the definition) that of Russia, as well as non-indigenous cuisines of Australasia, the Americas, Southern Africa, and Oceania, which derive substantial influence from European settlers in those regions. </a><br>
            <br>
            Menu yang tersedia<br><br>
            Spaghetti : Rp. 45.000 <br>
            Paket 4 Pancake : Rp 60.000 <br>
            Steak : Rp 120.000 <br>
            Pizza Large 4 : Rp 250.000 <br><br>
            <form action="<?php echo base_url('index.php/Paws/beliwestern'); ?>" method="post">
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/west1.png')?>">
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="western1">Beli Sekarang</button>
              </div>
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/west2.png')?>">
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="western2">Beli Sekarang</button>
              </div>
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/west3.png')?>">
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="western3">Beli Sekarang</button>
              </div>
              <div class="col-sm-2">
                <img src="<?php echo base_url('assets/west4.png')?>">
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="western4">Beli Sekarang</button>
              </div>
            </form>
          </div>
        </div>
