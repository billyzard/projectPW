    ...
    <div class="row">
      <div class="container-fluid">
        <div class="col-sm-8" style="background-color: ##f1f1f1; border-radius:10px; padding-bottom:20px"><br>
          <div id="about">
            <center><img src="<?php echo base_url('assets/jar.png'); ?>" width="75" height="75" ></center>
            <br><br>
            Minuman yang kami sediakan tentu segar dan cocok menemani makananmu, atau cuman buat sekedar duduk duduk cantik<br>

            Menu Minuman Yang Disediakan <br>
            Milkshake Vanilla <br>
            Milkshake Coklat <br>
            ...
            2 Jar  : Rp.20.000<br>
            6 Jar  : Rp.50.000<br>
            15 Jar : Rp.100.000<br>

            <br>
            <form action="<?php echo base_url('index.php/Paws/beliGems'); ?>" method="post">
              <div class="col-sm-2">
                <img src="<?php echo base_url('/assets/jar1.png')?>"/>
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="gems1">Beli Sekarang</button>
              </div>
              <div class="col-sm-2">
                <img src="<?php echo base_url('/assets/jar2.png')?>"/>
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="gems2">Beli Sekarang</button>
              </div>
              <div class="col-sm-2">
                <img src="<?php echo base_url('/assets/jar6.png')?> "/>
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="gems3">Beli Sekarang</button>
              </div>
              <div class="col-sm-2">
                <img src="<?php echo base_url('/assets/15jar.png')?> "/>
                <br><br>
                <button type="submit" class="btn" style="background-color:#FCB315; color:black" name="gems4">Beli Sekarang</button>
              </div>
            </form>
          </div>
        </div>
